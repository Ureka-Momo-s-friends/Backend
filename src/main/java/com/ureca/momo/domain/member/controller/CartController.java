...
public class CartController {
    ...
    public ResponseEntity<Long> createCart(@PathVariable final Long memberId, @RequestBody @Valid final CartRequest request) {
    ...
    // 장바구니 내 품목 수량 업데이트
    @PutMapping("/{id}")
    public ResponseEntity<Long> updateCart(@PathVariable(name = "id") final Long id, @RequestBody @Valid Integer number) {
